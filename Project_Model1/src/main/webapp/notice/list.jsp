		...
		<script src="/script/script_BBS.js"></script>
	    	...
	    	<main id="main">
	    		...
	    		<div id="contents" class="bbsList">
	    			<h3><a href="/notice/list.jsp">공지사항</a></h3>
	    		<%
	    		List<AdmBoardBean> list = admMgr.userGetNoticeList(keyWord, keyField, start, end);
	    		...
	    		%>
	    			...
	    			<table id="noticeList">
	    				...
	    				<%} else{
	   					...
	   					<tr class="prnTr" onclick="Read('<%=bean.getNum()%>', '<%=nowPage%>')">
	   						<td><%=bean.getNum() %></td>
	   						<td class="subjectTd">
   							<%out.print(bean.getSubject()+noticeChk);
   							if(filename!=null){
