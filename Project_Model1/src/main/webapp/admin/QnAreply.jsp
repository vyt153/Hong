...
%>
<jsp:useBean id="bean" class="pack.csc.CscBean" scope="session" />
<%
...
$(function () {
	...
	$("#backBtn").click(function () {
		...
		let p4 = "<%=keyWord%>";
		let num = "<%=num%>";
		let url ="/admin/QnAList.jsp?gnbParam=csc&nowPage"+param;
			url += "&keyField="+p3;
			url += "&keyWord="+p4;
			url += "&num="+num;
		location.href = url;
	...
	<main id="main" class="dFlex">
		...
		<div id="lnb">
   		...
   		<div id="contents" class="reply">
   			...
   			<form name="replyFrm" action="QnAreplyProc.jsp" method="get" id="replyFrm">
   				<h2>답변글 작성</h2>
   				...
   				<input type="hidden" name="uid" value="<%=admSession %>"/>
