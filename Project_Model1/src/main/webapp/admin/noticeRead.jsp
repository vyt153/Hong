...
<html lang="ko">
	...
	$(function () {
		...
		$("button#delNotidceBtn").click(function(){
			...
			if(chkTF){
				...
				let url ="/admin/noticeDeleteProc.jsp?";
				url += "num="+num+"&nowPage="+nowPage;
				url += "&keyField="+p3;
				url += "&keyWord="+p4;
				location.href = url;
					...
					<tfoot id="readTblFoot">	
						...
						<tr>
							...
							<td colspan="4" id="btnAreaTd" class="read">
								...
								<% }
									if (admSession.equals("admSuper")||admSession.equals(admId)||level.equals("Notice"))  { 
								%>
								<button type="button" id="noticeModBtn">수 정</button>
								<button type="button" id="delNotidceBtn">삭 제</button>
								<% } %>
