...
<%}%>
	...
	<nav id="mainLNB">
		<ul id="lnbMainMenu">
			...
			<%} else{ %>
			<li class="lnbMainLi"><a href="/admin/bbsList.jsp?gnbParam=bbs">자유게시판</a></li>
			<li class="lnbMainLi"><a href="/admin/galleryList.jsp?gnbParam=gallery">갤러리게시판</a></li>
			<li class="lnbMainLi"><a href="/admin/admNotice.jsp">공지사항</a></li>
			<li class="lnbMainLi"><a href="/admin/adminUserInfoDetails.jsp">회원관리</a></li>
			<li class="lnbMainLi"><a href="/admin/QnAList.jsp">Q&A</a></li>
