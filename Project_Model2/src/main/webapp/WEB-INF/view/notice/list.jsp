<%@page import="pack.entity.Notice"%>
...
<link href="/html/css/customer/layout.css" type="text/css" rel="stylesheet" />
<style>
#visual .content-container {
	height: inherit;
	display: flex;
	align-items: center;
	background: url("/html/images/customer/visual.png") no-repeat center;
}
</style>
</head>
...
<body>
	...
	<header id="header">
		...
		<div class="content-container">
			...
			<h1 id="logo">
				<a href="/html/index.html"> <img src="/html/images/logo.png"
					alt="뉴렉처 온라인" />
				...
				<div class="sub-menu">
					...
					<nav id="acount-menu">
						...
						<ul>
							...
							<li><a href="/html/member/login.html">로그인</a></li>
							<li><a href="/html/member/agree.html">회원가입</a></li>
						</ul>
					</nav>
					...
					<nav id="member-menu" class="linear-layout">
						...
						<ul class="linear-layout">
							<li><a href="/member/home"><img
									src="/html/images/txt-mypage.png" alt="마이페이지" /></a></li>
							<li><a href="/notice/list.html"><img
									src="/html/images/txt-customer.png" alt="고객센터" /></a></li>
						</ul>
					</nav>
				...
				<nav class="menu">
					...
					<ul>
						<li><a target="_blank" href="http://www.notepubs.com"><img
								src="/html/images/notepubs.png" alt="노트펍스" /></a></li>
						<li><a target="_blank" href="http://www.namoolab.com"><img
								src="/html/images/namoolab.png" alt="나무랩연구소" /></a></li>
...
<%-- <%-- 						%> --%> 
							...
							<tr>
								...
								<td class="title indent text-align-left"><a
									href="detail?id=${n.id }">${n.title }</a><span style="color:red">[${n.cmtCount }]</span></td>
								<td>${n.writer_ID }</td>
