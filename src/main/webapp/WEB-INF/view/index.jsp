...
<head>
    ...
    <link href="/html/css/layout.css" type="text/css" rel="stylesheet" />
...
<body>
        ...
        <div class="content-container">
            ...
            <h1 id="logo">
                <a href="/html/index.html">
                    <img src="/html/images/logo.png" alt="뉴렉처 온라인" />
                ...
                <div class="sub-menu">
                    ...
                    <nav id="member-menu" class="linear-layout">
                        ...
                        <ul class="linear-layout">
                            <li><a href="/member/home"><img src="/html/images/txt-mypage.png" alt="마이페이지" /></a></li>
                            <li><a href="/notice/list.jsp"><img src="/html/images/txt-customer.png" alt="고객센터" /></a></li>
                        </ul>
                    </nav>
        ...
        <div class="content-container">
            <section class="guide">
                ...
                <div class="margin-top">
                    <a href="customer/faq/1"><img src="/html/images/customer/installInfo.png" /></a>
                </div>
                <!-- <div>
            2
            </div>
                ...
                <ul class="list margin-top">
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/admin/board/notice/list">스프링 8강까지의 예제 코드</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/admin/board/notice/list">스프링 DI 예제 코드</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/admin/board/notice/list">뉴렉쌤 9월 초 국기과정 모집 안내</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/admin/board/notice/list">뉴렉처 강의 수강 방식 안내</a>
                        </span>
                    ...
                    <li>
                        <span class="notice-title">
                            <a href="/admin/board/notice/list">자바 구조적인 프로그래밍 강의 예제 파일</a>
                        </span>
    ...
    <main id="course">
        <section class="content-container list list-horizontal list-course list-course-index">
            ...
            <ul>
                ...
                <li class="item-course normal event">
                    <div>
                        <a href="course/2"><img src="/html/images/course/java.png" /></a>                        
                    </div>
                    <div>
                        <div>
        ...
        <div class="content-container">
            ...
            <ul class="-list- horizontal center -margin- bottom top b20">
                <li><a target="_blank" href="http://www.notepubs.com"><img src="/html/images/notepubs.png" alt="노트펍스" /></a></li>
                <li><a target="_blank" href="http://www.namoolab.com"><img src="/html/images/namoolab.png" alt="나무랩연구소" /></a></li>                
    ...
    <footer id="footer">
        <div class="content-container">
            <h2 id="footer-logo"><img src="/html/images/logo-footer.png" alt="회사정보"></h2>
